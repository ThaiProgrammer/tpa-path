...
Angular คือ web framework หรือชุดเครื่องมือสำหรับสร้างเว็บไซต์ที่พัฒนาโดยทีมของบริษัท Google ซึ่งมีเครื่องมือต่างๆ พร้อมใช้งานในตัว เช่น CLI (Command Line Interface) ใช้ทำคำสั่งเกี่ยวกับ Angular, HTTP Client สำหรับรับหรือส่งคำขอ HTTP, Jasmine และ Karma สำหรับทำ Testing, เครื่องมือเกี่ยวกับการทำแบบฟอร์ม ฯลฯ และการเชื่อมโยงข้อมูลระหว่าง UI ก็สามารถทำได้ด้วย two-way data binding นอกจากนี้ยังถือเป็น framework แรกที่ใช้ [TypeScript](https://roadmap.thaiprogrammer.org/paths/web-guideline/frontend/typescript.html) เป็นหลักจึงทำให้โค้ดมีคุณภาพและพัฒนาต่อได้ง่ายขึ้น และเป็น framework ที่ใช้เทคนิค Dependency Injection ที่คล้ายกับในภาษา Java หรือ C# อีกด้วย เป็นเทคนิคในการส่งต่อโค้ดหรือ dependency แทนที่จะสร้างใหม่ Angular ใช้ในการพัฒนาเว็บแอปพลิเคชั่นและเว็บไซต์ต่างๆ แต่จะนิยมในองค์กรระดับ enterprise มากกว่า
...
- **[freeCodeCamp | Build a Webshop – Angular, Node.js, TypeScript, Stripe](https://www.youtube.com/watch?v=Kbauf9IgsC4)**
